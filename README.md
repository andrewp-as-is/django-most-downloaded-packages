...
| 2 | [django-extensions](https://github.com/django-extensions/django-extensions) | Extensions for Django | **1M**/month |
| 3 | [django-cors-headers](https://github.com/adamchainz/django-cors-headers) | django-cors-headers is a Django application for handling the server he... | **1M**/month |
| 4 | [django-filter](https://github.com/carltongibson/django-filter) | Django-filter is a reusable Django application for allowing users to f... | **1M**/month |
...
| 16 | [djangorestframework-simpl...](https://github.com/SimpleJWT/django-rest-framework-simplejwt) | A minimal JSON Web Token authentication plugin for Django REST Framewo... | **278k**/month |
...
| 35 | [djangorestframework-camel...](https://github.com/vbabiy/djangorestframework-camel-case) | Camel case JSON support for Django REST framework. | **150k**/month |
...
| 37 | [django-polymorphic](https://github.com/django-polymorphic/django-polymorphic) | Seamless polymorphic inheritance for Django models | **148k**/month |
...
| 39 | [django-taggit](https://github.com/jazzband/django-taggit) | django-taggit is a reusable Django application for simple tagging. | **139k**/month |
...
| 56 | [django-ckeditor](https://github.com/django-ckeditor/django-ckeditor) | Django admin CKEditor integration. | **113k**/month |
| 57 | [django-picklefield](https://github.com/gintas/django-picklefield) | Pickled object field for Django | **113k**/month |
...
| 70 | [django-csp](https://github.com/mozilla/django-csp) | Django Content Security Policy support. | **75k**/month |
| 71 | [django-coverage-plugin](https://github.com/nedbat/django_coverage_plugin) | Django template coverage.py plugin | **72k**/month |
...
| 87 | [django-admin-sortable2](https://github.com/jrief/django-admin-sortable2) | Generic drag-and-drop sorting for the List, the Stacked- and the Tabul... | **55k**/month |
| 88 | [djangorestframework-xml](https://github.com/jpadilla/django-rest-framework-xml) | XML support for Django REST Framework | **55k**/month |
...
| 91 | [django-modelcluster](https://github.com/wagtail/django-modelcluster) | Django extension to allow working with clusters of models as a single ... | **54k**/month |
...
| 100 | [django-annoying](https://github.com/skorokithakis/django-annoying) | This is a django application that tries to eliminate annoying things i... | **48k**/month |
...
| 117 | [django-ordered-model](https://github.com/bfirsh/django-ordered-model) | Allows Django models to be ordered and provides a simple admin interfa... | **42k**/month |
...
| 141 | [django-dbsettings](https://github.com/zlorf/django-dbsettings) | Application settings whose values can be updated while a project is up... | **33k**/month |
| 142 | [django-celery-email](https://pypi.org/project/django-celery-email/) | An async Django email backend using celery | **33k**/month |
...
| 145 | [django-reversion-compare](https://github.com/jedie/django-reversion-compare) | history compare for django-reversion | **32k**/month |
| 146 | [django-sortedm2m](https://github.com/jazzband/django-sortedm2m) | Drop-in replacement for djangos many to many field with sorted relatio... | **31k**/month |
...
| 159 | [django-smtp-ssl](https://github.com/bancek/django-smtp-ssl) | SMTP SSL email backend for Django | **28k**/month |
| 160 | [django-suit](https://github.com/darklow/django-suit) | Modern theme for Django admin interface. | **27k**/month |
| 161 | [django-rosetta](https://github.com/mbi/django-rosetta) | A Django application that eases the translation of Django projects | **27k**/month |
...
| 172 | [django-debug-toolbar-requ...](https://github.com/djsutho/django-debug-toolbar-request-history) | Request History Panel for Django Debug Toolbar | **25k**/month |
...
| 191 | [django-simple-captcha](https://github.com/mbi/django-simple-captcha) | A very simple, yet powerful, Django captcha application | **21k**/month |
...
| 210 | [djangorestframework-jsonp](https://github.com/jpadilla/django-rest-framework-jsonp) | JSONP support for Django REST Framework | **19k**/month |
...
| 231 | [django-sslify](https://github.com/rdegges/django-sslify) | Force SSL on your Django site. | **16k**/month |
...
| 235 | [django-static](https://github.com/peterbe/django-static) | Template tags for better serving static files from templates in Django | **16k**/month |
...
| 251 | [django-composite-foreignk...](https://github.com/onysos/django-composite-foreignkey) | composite foreignkey support for django | **15k**/month |
...
| 279 | [django-sequences](https://github.com/aaugustin/django-sequences) | Generate gapless sequences of integer values. | **13k**/month |
...
| 290 | [django-stdimage](https://github.com/codingjoe/django-stdimage) | Django Standarized Image Field | **12k**/month |
...
| 292 | [django-netfields](https://github.com/jimfunk/django-postgresql-netfields) | Django PostgreSQL netfields implementation | **12k**/month |
...
| 297 | [django-swstags](https://pypi.org/project/django-swstags/) |  | **12k**/month |
...
| 299 | [django-material](https://github.com/viewflow/django-material) | Material design for django forms and admin | **11k**/month |
...
| 311 | [django-queryset-csv](https://github.com/azavea/django-queryset-csv) | A simple python module for writing querysets to csv | **11k**/month |
| 312 | [django-s3-folder-storage](https://github.com/jamstooks/django-s3-folder-storage) | Quick extension of django-storages S3BotoStorage to allow separate fol... | **11k**/month |
...
| 354 | [django-fobi](https://github.com/barseghyanartur/django-fobi) | Form generator/builder application for Django done right: customisable... | **9k**/month |
...
| 378 | [django-reverse-admin](https://github.com/daniyalzade/django_reverse_admin) |  | **8k**/month |
...
| 382 | [djangorestframework-datac...](https://github.com/oxan/djangorestframework-dataclasses) | A dataclasses serializer for Django REST Framework | **8k**/month |
| 383 | [django-proxy](https://github.com/mjumbewu/django-proxy) | A simple HTTP proxy service as a Django app | **8k**/month |
...
| 394 | [django-sendfile2](https://github.com/moggers87/django-sendfile2) | Abstraction to offload file uploads to web-server (e.g. Apache with mo... | **8k**/month |
...
| 399 | [django-cogwheels](https://github.com/ababic/django-cogwheels) | A consistent, user-friendly solution for adding app-specific settings ... | **8k**/month |
...
| 404 | [django-postgrespool](https://github.com/heroku-python/django-postgrespool) | Postgres Connection Pooling for Django. | **8k**/month |
...
| 441 | [django-bridger](https://pypi.org/project/django-bridger/) | The bridge between a Django Backend and a Javascript based Frontend | **7k**/month |
| 442 | [django-jquery-js](https://pypi.org/project/django-jquery-js/) | jQuery, bundled up so apps can depend upon it | **7k**/month |
| 443 | [django-localflavor-us](https://pypi.org/project/django-localflavor-us/) | Country-specific Django helpers for U.S.A. | **7k**/month |
...
| 470 | [django-codemirror-widget](https://github.com/lambdalisue/django-codemirror-widget) | Django form widget library for using CodeMirror on textarea | **6k**/month |
...
| 478 | [django-ptree](https://github.com/oTree-org/otree-core) | pTree is a Django toolset that makes it easy to create and administer ... | **6k**/month |
...
| 492 | [django-keen](https://pypi.org/project/django-keen/) | Simple wrapper for django around the official keen.io client | **6k**/month |
...
| 509 | [django-cursor-pagination](https://github.com/photocrowd/django-cursor-pagination) | Cursor based pagination for Django | **5k**/month |
...
| 524 | [django-admin-multiple-cho...](https://github.com/ctxis/django-admin-multiple-choice-list-filter) | A Django app to add a Multiple Choice List Filter to the admin interfa... | **5k**/month |
...
| 540 | [django-mapstore-adapter](https://github.com/GeoNode/django-mapstore-adapter) | Django MapStore2 Adapter | **5k**/month |
| 541 | [django-jsonify](https://pypi.org/project/django-jsonify/) | Django additions for JSON | **5k**/month |
| 542 | [django-comments-xtd](https://pypi.org/project/django-comments-xtd/) | Django Comments Framework extension app with thread support, follow up... | **5k**/month |
| 543 | [django-composite-field](https://pypi.org/project/django-composite-field/) | CompositeField implementation for Django | **5k**/month |
| 544 | [django-coverage](https://pypi.org/project/django-coverage/) | Django Test Coverage App | **5k**/month |
| 545 | [django-form-utils](https://pypi.org/project/django-form-utils/) | Form utilities for Django | **5k**/month |
| 546 | [django-geonode-mapstore-c...](https://github.com/GeoNode/geonode-client) | Use GeoNode client in your django projects | **5k**/month |
...
| 557 | [django-hvad](https://github.com/KristianOellegaard/django-hvad) | A content translation framework for django integrated automatically in... | **4k**/month |
| 558 | [django-rest-hooks](https://github.com/zapier/django-rest-hooks) | A powerful mechanism for sending real time API notifications via a new... | **4k**/month |
| 559 | [django-wysiwyg](https://github.com/pydanny/django-wysiwyg) | django-wysiwyg | **4k**/month |
| 560 | [django-autofixture](https://github.com/gregmuellegger/django-autofixture) | Provides tools to auto generate test data. | **4k**/month |
| 561 | [django-nvd3](https://github.com/areski/django-nvd3) | Django NVD3 - Chart Library for d3.js | **4k**/month |
| 562 | [django-smuggler](https://github.com/semente/django-smuggler) | Pluggable application for Django that helps you to import/export fixtu... | **4k**/month |
| 563 | [django-authtools](https://github.com/fusionbox/django-authtools) | Custom user model app for Django featuring email as username and class... | **4k**/month |
| 564 | [django-geoposition](https://github.com/philippbosch/django-geoposition) | Django model field that can hold a geoposition, and corresponding admi... | **4k**/month |
| 565 | [django-chartjs](https://github.com/peopledoc/django-chartjs) | Django Chart.js and Hightchart ajax views | **4k**/month |
| 566 | [django-cassandra-engine](https://github.com/r4fek/django-cassandra-engine) | Django Cassandra Engine - the Cassandra backend for Django | **4k**/month |
| 567 | [django-service-objects](https://github.com/mixxorz/django-service-objects) | Service objects for Django | **4k**/month |
| 568 | [django-positions](https://github.com/jpwatts/django-positions) | A Django field for custom model ordering | **4k**/month |
| 569 | [django-tagulous](https://github.com/radiac/django-tagulous) | Fabulous Tagging for Django | **4k**/month |
| 570 | [django-multiupload](https://github.com/Chive/django-multiupload) | Dead simple drop-in multi file upload field for django forms using HTM... | **4k**/month |
| 571 | [django-mailbox](https://github.com/coddingtonbear/django-mailbox) | Import mail from POP3, IMAP, local mailboxes or directly from Postfix ... | **4k**/month |
| 572 | [django-require](https://github.com/etianen/django-require) | A Django staticfiles post-processor for optimizing with RequireJS. | **4k**/month |
| 573 | [django-salesforce](https://github.com/django-salesforce/django-salesforce) | a Salesforce backend for Djangos ORM | **4k**/month |
| 574 | [django-nap](https://github.com/funkybob/django-nap) | A light REST tool for Django | **4k**/month |
| 575 | [django-webpush](https://github.com/safwanrahman/django-webpush) | A simple Django package to integrate Web Push Notification in your App... | **4k**/month |
| 576 | [django-datetime-widget](https://github.com/asaglimbeni/django-datetime-widget) | Django-datetime-widget is a simple and clean widget for DateField, Tim... | **4k**/month |
| 577 | [django-livereload-server](https://github.com/tjwalch/django-livereload-server) | LiveReload functionality integrated with your Django development envir... | **4k**/month |
| 578 | [django-graphql-auth](https://github.com/PedroBern/django-graphql-auth) | Graphql and relay authentication with Graphene for Django. | **4k**/month |
| 579 | [django-query-builder](https://github.com/ambitioninc/django-query-builder) | Build complex nested queries | **4k**/month |
| 580 | [django-auto-prefetching](https://github.com/GeeWee/django-auto-prefetching) | Tools for automatically prefetching related objects in Django and Djan... | **4k**/month |
| 581 | [django-npm](https://github.com/kevin1024/django-npm) | A django staticfiles finder that uses npm | **4k**/month |
| 582 | [django-rest-framework-pro...](https://github.com/eofs/django-rest-framework-proxy) | Django Rest Framework Proxy allows easy proxying of incoming REST requ... | **4k**/month |
| 583 | [django-resized](https://github.com/un1t/django-resized) | Resizes image origin to specified size. | **4k**/month |
| 584 | [django-infinite-scroll-pa...](https://github.com/nitely/django-infinite-scroll-pagination) | infinite-scroll-pagination is a Django lib that implementsthe *seek me... | **4k**/month |
| 585 | [django-fieldsignals](https://github.com/craigds/django-fieldsignals) | Django fieldsignals simply makes it easy to tell when the fields on yo... | **4k**/month |
| 586 | [django-storage-swift](https://github.com/dennisv/django-storage-swift) | OpenStack Swift storage backend for Django | **4k**/month |
| 587 | [django-reset-migrations](https://github.com/valdergallo/django-reset-migrations) | Add one command to reset the migrations of one or more app | **4k**/month |
| 588 | [django-polymodels](https://github.com/charettes/django-polymodels) | Polymorphic models implementation for django | **4k**/month |
| 589 | [django-nocaptcha-recaptch...](https://github.com/ImaginaryLandscape/django-nocaptcha-recaptcha) | Django nocaptcha recaptcha form field/widget app. | **4k**/month |
| 590 | [django-pgjsonb](https://github.com/yjmade/django-pgjsonb) | Django Postgres JSONB Fields support with lookups | **4k**/month |
| 591 | [django-kombu](https://github.com/ask/django-kombu) | Kombu transport using the Django database as a message store. | **4k**/month |
| 592 | [django-calaccess-raw-data](https://github.com/california-civic-data-coalition/django-calaccess-raw-data) | A Django app to download, extract and load campaign finance and lobbyi... | **4k**/month |
| 593 | [django-subscriptions](https://github.com/kogan/django-subscriptions) | A django package for managing subscription states | **4k**/month |
| 594 | [django-icons](https://github.com/zostera/django-icons) | Icons for Django | **4k**/month |
| 595 | [django-manager-utils](https://github.com/ambitioninc/django-manager-utils) | Model manager utilities for Django | **4k**/month |
| 596 | [django-post-request-task](https://github.com/mozilla/django-post-request-task) | A celery task class whose execution is delayed until after the request... | **4k**/month |
| 597 | [django-db-file-storage](https://github.com/victor-o-silva/db_file_storage) | Custom FILE_STORAGE for Django. Saves files in your database instead o... | **4k**/month |
| 598 | [django-s3file](https://github.com/codingjoe/django-s3file) | A lightweight file uploader input for Django and Amazon S3 | **4k**/month |
| 599 | [django-getenv](https://github.com/schwuk/django-getenv) | Read settings from environment variables. | **4k**/month |
| 600 | [django-sass](https://github.com/coderedcorp/django-sass) | The absolute simplest way to use Sass with Django. Pure Python, minima... | **4k**/month |
| 601 | [django-rest-witchcraft](https://github.com/shosca/django-rest-witchcraft) | Django REST Framework and SQLAlchemy integration | **4k**/month |
| 602 | [django-smoketest](https://github.com/ccnmtl/django-smoketest) | Django smoketest framework | **4k**/month |
| 603 | [django-password-validatio...](https://github.com/orcasgit/django-password-validation) | Backport of Django 1.9 password validation | **4k**/month |
| 604 | [django-admin-ordering](https://github.com/matthiask/django-admin-ordering) | Orderable change lists and inlines done right^Wsimple | **4k**/month |
| 605 | [django-macros](https://github.com/nalourie/django-macros) | A Django template tag library for repeating blocks tags and creating i... | **4k**/month |
| 606 | [django-capture-on-commit-...](https://github.com/adamchainz/django-capture-on-commit-callbacks) | Capture and make assertions on transaction.on_commit() callbacks. | **4k**/month |
| 607 | [django-userforeignkey](https://github.com/beachmachine/django-userforeignkey) | A simple Django app that will give you a UserForeignKey model field. | **4k**/month |
| 608 | [django-unique-upload](https://github.com/agconti/django-unique-upload) | A django utility that creates unique file names for uploaded files via... | **4k**/month |
| 609 | [django-formidable](https://github.com/peopledoc/django-formidable) | django-formidable is a full django application which allows you to cre... | **4k**/month |
| 610 | [django-user-tasks](https://github.com/edx/django-user-tasks) | Management of user-triggered asynchronous tasks in Django projects | **4k**/month |
| 611 | [django-admin-hstore-widge...](https://github.com/PokaInc/django-admin-hstore-widget) | Widget and Field to properly render HStore data in Django-Admin | **4k**/month |
| 612 | [django-pgconnection](https://github.com/jyveapp/django-pgconnection) | Route postgres connections and hook into cursor execution | **4k**/month |
| 613 | [djangofloor](https://github.com/d9pouces/django-floor) | Simple configuration management and websockets with Django. | **4k**/month |
| 614 | [django-security-logger](https://github.com/druids/django-security) | Django security library. | **4k**/month |
| 615 | [django-basic-auth-ip-whit...](https://github.com/tm-kn/django-basic-auth-ip-whitelist) | Hide your Django site behind basic authentication mechanism with IP wh... | **4k**/month |
| 616 | [django-cool](https://github.com/007gzs/django-cool) | Cool to use for the Django Framework. | **4k**/month |
| 617 | [django-project-version](https://github.com/DCOD-OpenSource/django-project-version) | Django reusable app to show your project version | **4k**/month |
| 618 | [django-test-tools](https://github.com/luiscberrocal/django-test-tools) | Simple tests tools to make testing faster and easier. | **4k**/month |
| 619 | [django-pyfs](https://github.com/edx/django-pyfs) | Django pyfilesystem integration | **4k**/month |
| 620 | [django-trips](https://github.com/awaisdar001/django-trips) | A Django Rest API for fetching and creating trips and their schedules. | **4k**/month |
| 621 | [django-dynamic-storages](https://github.com/mcclory/django-dynamic-storages) | A collection of file fields and associated components to allow for dyn... | **4k**/month |
| 622 | [django-djcopyright](https://github.com/vint21h/django-djcopyright) | Django reusable app to show pretty formatted copyright years | **4k**/month |
| 623 | [django-nyt](https://github.com/benjaoming/django-nyt) | A pluggable notification system written for the Django framework. | **4k**/month |
| 624 | [djangoldp-circle](https://pypi.org/project/djangoldp-circle/) | djangoldp package for circle data models | **4k**/month |
| 625 | [django-vanilla-views](https://github.com/tomchristie/django-vanilla-views) | Beautifully simple class based views. | **4k**/month |
| 626 | [djangoldp-notification](https://pypi.org/project/djangoldp-notification/) | djangoldp package for notifications data models | **4k**/month |
| 627 | [djangoldp-project](https://pypi.org/project/djangoldp-project/) | djangoldp package for project data models | **4k**/month |
| 628 | [django-docs](https://pypi.org/project/django-docs/) | Allows to serve Sphinx generated docs from django. | **4k**/month |
| 629 | [django-global-requests](https://pypi.org/project/django-global-requests/) | Global request objects for Django | **4k**/month |
| 630 | [django-jquery](https://pypi.org/project/django-jquery/) | jQuery packaged in an handy django app to speed up new applications an... | **4k**/month |
| 631 | [django-mako-plus](https://pypi.org/project/django-mako-plus/) | Django+Mako: Routing by Convention, Python-Centric Template Language | **4k**/month |
| 632 | [django-oscar-bluelight](https://pypi.org/project/django-oscar-bluelight/) | Bluelight Specials - Enhancements to the offer and vouchers features f... | **4k**/month |
| 633 | [django-apar](https://pypi.org/project/django-apar/) | Aparnik is a simple Django app to help about some common problems. | **4k**/month |
| 634 | [django-bigbuild](https://pypi.org/project/django-bigbuild/) | The open-source engine that powers bigbuilder, the Los Angeles Times D... | **4k**/month |
| 635 | [django-dont-vary-on](https://pypi.org/project/django-dont-vary-on/) | Library for Django to give you more control over Djangos caching, and ... | **4k**/month |
| 636 | [django-fakery](https://pypi.org/project/django-fakery/) | A model instances generator for Django | **4k**/month |
| 637 | [django-formset-js](https://pypi.org/project/django-formset-js/) | Extend Django formsets with JavaScript | **4k**/month |
| 638 | [django-inoa](https://pypi.org/project/django-inoa/) | Collection of django tools and snippets commonly used by Inoa. | **4k**/month |
| 639 | [Django-local-lib](https://github.com/joseph-njogu/Django_local_lib) | Python wrapper for the CircleCI API | **4k**/month |
| 640 | [django-method-override](https://pypi.org/project/django-method-override/) | Django Middleware for HTTP Method Override Form Params & Header | **4k**/month |
...
| 651 | [django-machina](https://github.com/ellmetha/django-machina) | A Django forum engine for building powerful community driven websites. | **3k**/month |
| 652 | [django-parsley](https://github.com/agiliq/Django-parsley) | Django app for client-side form validation. Wrapper for parsley.js | **3k**/month |
| 653 | [django-graphos](https://github.com/agiliq/django-graphos) | Django app to provide a JS agnostic way to work with charts. | **3k**/month |
| 654 | [django-markdown](https://github.com/klen/django_markdown) | Django markdown support and wysiwyg. | **3k**/month |
| 655 | [django-lazysignup](https://github.com/danfairs/django-lazysignup) | Lazy signup for Django | **3k**/month |
| 656 | [django-bakery](https://github.com/datadesk/django-bakery) | A set of helpers for baking your Django site out as flat files | **3k**/month |
| 657 | [django-field-history](https://github.com/grantmcconnaughey/django-field-history) | A Django app to track changes to a model field. | **3k**/month |
| 658 | [django-sudo](https://github.com/mattrobenolt/django-sudo) | Extra security for your sensitive pages | **3k**/month |
| 659 | [django-address](https://github.com/furious-luke/django-address) | A django application for describing addresses. | **3k**/month |
| 660 | [django-memcache-status](https://github.com/bartTC/django-memcache-status) | A django application that displays the load and other statistics about... | **3k**/month |
| 661 | [django-admin-easy](https://github.com/ebertti/django-admin-easy) | Collection of admin fields and decorators to help to create computed o... | **3k**/month |
| 662 | [django-front](https://github.com/mbi/django-front) | A Django application to allow of front-end editing | **3k**/month |
| 663 | [django-security](https://github.com/sdelements/django-security) | A collection of tools to help secure a Django project. | **3k**/month |
| 664 | [django-perf-rec](https://github.com/adamchainz/django-perf-rec) | Keep detailed records of the performance of your Django code. | **3k**/month |
| 665 | [django-dbtemplates](https://github.com/jazzband/django-dbtemplates) | Template loader for templates stored in the database | **3k**/month |
| 666 | [django-sendsms](https://github.com/stefanfoulis/django-sendsms) | A simple API to send SMS messages. | **3k**/month |
| 667 | [django-rest-marshmallow](https://github.com/marshmallow-code/django-rest-marshmallow) | Marshmallow schemas for Django REST framework | **3k**/month |
| 668 | [django-pyodbc](https://github.com/lionheart/django-pyodbc) | Django 1.5-1.10 SQL Server backend using pyodbc. | **3k**/month |
| 669 | [django-markupfield](https://github.com/jamesturk/django-markupfield) | Custom Django field for easy use of markup in text fields | **3k**/month |
| 670 | [django-encrypted-fields](https://github.com/defrex/django-encrypted-fields) | This is a collection of Django Model Field classes that are encrypted ... | **3k**/month |
| 671 | [django-tracking2](https://github.com/bruth/django-tracking2) | django-tracking2 tracks the length of time visitors and registered use... | **3k**/month |
| 672 | [django-simple-email-confi...](https://github.com/mfogel/django-simple-email-confirmation) | Simple email confirmation for django. | **3k**/month |
| 673 | [django-chunked-upload](https://github.com/juliomalegria/django-chunked-upload) | Upload large files to Django in multiple chunks, with the ability to r... | **3k**/month |
| 674 | [django-polymorphic-tree](https://github.com/django-polymorphic/django-polymorphic-tree) | A polymorphic mptt structure to display content in a tree. | **3k**/month |
| 675 | [django-dynamic-raw-id](https://github.com/lincolnloop/django-dynamic-raw-id) | raw_id_fields widget replacement that handles display of an objects st... | **3k**/month |
| 676 | [django-taggit-templatetag...](https://github.com/feuervogel/django-taggit-templatetags) | Templatetags for django-taggit. | **3k**/month |
| 677 | [django-maintenancemode](https://github.com/shanx/django-maintenancemode) | django-maintenancemode allows you to temporary shutdown your site for ... | **3k**/month |
| 678 | [django-wysiwyg-redactor](https://github.com/django-cumulus/django-cumulus) | django-wysiwyg-redactor is a lightweight responsive wysiwyg editor for... | **3k**/month |
| 679 | [django_celery_monitor](https://github.com/jazzband/django-celery-monitor) | Celery monitor for Django. | **3k**/month |
| 680 | [django-filebrowser-no-gra...](https://github.com/smacker/django-filebrowser-no-grappelli) | Media-Management no Grappelli | **3k**/month |
| 681 | [django-json-field](https://github.com/derek-schaefer/django-json-field) | Generic JSON model and form fields. | **3k**/month |
| 682 | [django-hardcopy](https://github.com/loftylabs/django-hardcopy) | Django wrapper and utilities for generating PDF and PNG files with con... | **3k**/month |
| 683 | [django-rest-authemail](https://github.com/celiao/django-rest-authemail) | A RESTful API for user signup and authentication using email addresses | **3k**/month |
| 684 | [django-pattern-library](https://github.com/torchbox/django-pattern-library) | A module for Django that allows to build pattern libraries for your pr... | **3k**/month |
| 685 | [django-file-form](https://github.com/mbraak/django-file-form) | Django-file-form helps you to write forms with a pretty ajax upload | **3k**/month |
| 686 | [django-simple-menu](https://github.com/jazzband/django-simple-menu) | Simple, yet powerful, code-based menus for Django applications | **3k**/month |
| 687 | [django-db-readonly](https://github.com/streeter/django-db-readonly) | Add a global database read-only setting. | **3k**/month |
| 688 | [django-termsandconditions](https://github.com/cyface/django-termsandconditions) | Django app that enables users to accept terms and conditions of a site... | **3k**/month |
| 689 | [django-currencies](https://github.com/panosl/django-currencies) | Adds support for multiple currencies as a Django application. | **3k**/month |
| 690 | [django-unused-media](https://github.com/akolpakov/django-unused-media) | Delete unused media files from Django project | **3k**/month |
| 691 | [django-improved-user](https://github.com/jambonsw/django-improved-user) | A custom Django user model for best practices email-based login. | **3k**/month |
| 692 | [django-clear-cache](https://github.com/rdegges/django-clear-cache) | A simple Django management command which clears your cache. | **3k**/month |
| 693 | [django-tables2-reports](https://github.com/goinnn/django-tables2-reports) | With django-tables2-reports you can get a report (CSV, XLS) of any dja... | **3k**/month |
| 694 | [django-pb-model](https://github.com/myyang/django-pb-model) | Protobuf mixin for Django model | **3k**/month |
| 695 | [django-naomi](https://github.com/edwinlunando/django-naomi) | Email backend for Django. Preview your email in browser instead of sen... | **3k**/month |
| 696 | [django-formset-js-improve...](https://github.com/pretix/django-formset-js) | Extend Django formsets with JavaScript | **3k**/month |
| 697 | [django-file-resubmit](https://github.com/un1t/django-file-resubmit) | Keeps submited files when validation errors occur. | **3k**/month |
| 698 | [django-taggit-labels](https://github.com/bennylope/django-taggit-labels) | Alternate labels for django-taggit | **3k**/month |
| 699 | [django-localized-fields](https://github.com/SectorLabs/django-localized-fields) | Implementation of localized model fields using PostgreSQL HStore field... | **3k**/month |
| 700 | [django-simple-mail](https://github.com/VingtCinq/django-simple-mail) | A simple and customizable email template built for Django | **3k**/month |
| 701 | [django-app-namespace-temp...](https://github.com/Fantomas42/django-app-namespace-template-loader) | Template loader allowing you to both extend and override a template at... | **3k**/month |
| 702 | [django-sniplates](https://github.com/funkybob/django-sniplates) | Efficient template macro sets for Django | **3k**/month |
| 703 | [django-user-management](https://github.com/incuna/django-user-management) | User management model mixins and api views. | **3k**/month |
| 704 | [django-tabbed-admin](https://github.com/omji/django-tabbed-admin) | Easily add tabs to django admin forms. | **3k**/month |
| 705 | [django-entity](https://github.com/ambitioninc/django-entity) | Entity relationship management for Django | **3k**/month |
| 706 | [django-dynamic-db-router](https://github.com/ambitioninc/django-dynamic-db-router) | Simply route complex django queries to multiple databases. | **3k**/month |
| 707 | [django-computedfields](https://github.com/netzkolchose/django-computedfields) | autoupdated database fields for model methods | **3k**/month |
| 708 | [django-grip](https://github.com/fanout/django-grip) | Django GRIP library | **3k**/month |
| 709 | [django-admin-numeric-filt...](https://github.com/lukasvinclav/django-admin-numeric-filter) | Numeric filters for Django admin | **3k**/month |
| 710 | [django-modelclone](https://github.com/RealGeeks/django-modelclone) | Django application that allows users to clone a model in Admin | **3k**/month |
| 711 | [django-postgres-composite...](https://github.com/danni/django-postgres-composite-types) | Postgres composite types support for Django | **3k**/month |
| 712 | [django-richtextfield](https://github.com/jaap3/django-richtextfield) | A Django model field and widget that renders a customizable WYSIWYG/ri... | **3k**/month |
| 713 | [django-related-admin](https://github.com/PetrDlouhy/django-related-admin) | Allow foreign key attributes in list_display with __ | **3k**/month |
| 714 | [django-jstemplate](https://github.com/mjumbewu/django-jstemplate) | A Django template tag for embedding Mustache.js templates -- or other ... | **3k**/month |
| 715 | [django-bulk-sync](https://github.com/mathandpencil/django-bulk-sync) | Combine bulk add, update, and delete into a single call. | **3k**/month |
| 716 | [django-vies](https://github.com/codingjoe/django-vies) | Validate and store VAT Information Exchange System (VIES) data in Djan... | **3k**/month |
| 717 | [django-eth-events](https://github.com/gnosis/django-eth-events) | A simple Django app to react to Ethereum events. | **3k**/month |
| 718 | [django-imagefield](https://github.com/matthiask/django-imagefield) | Image field for Django | **3k**/month |
| 719 | [django-cuser](https://github.com/Alir3z4/django-cuser) | Middleware to make user information always available. | **3k**/month |
| 720 | [django-lrucache-backend](https://github.com/kogan/django-lrucache-backend) | A smarter local memory cache backend for Django | **3k**/month |
| 721 | [django-iprestrict](https://github.com/muccg/django-iprestrict) | Django app + middleware to restrict access to all or sections of a Dja... | **3k**/month |
| 722 | [django-clone](https://github.com/tj-django/django-clone) | Create a clone of a django model instance. | **3k**/month |
| 723 | [django-factory_boy](https://github.com/FactoryBoy/django-factory_boy) | Uses factory_boy to supply test data factory classes for all stock Dja... | **3k**/month |
| 724 | [django-gfklookupwidget](https://github.com/mqsoh/django-gfklookupwidget) | A widget to replace the object_id in a generic relation with a search ... | **3k**/month |
| 725 | [django-i18nfield](https://github.com/raphaelm/django-i18nfield) | Store internationalized strings in Django models | **3k**/month |
| 726 | [django-app-helper](https://github.com/nephila/django-app-helper) | Helper for django applications development | **3k**/month |
| 727 | [django-zxcvbn-password-va...](https://github.com/Pierre-Sassoulas/django-zxcvbn-password-validator) | A translatable password validator for django, based on zxcvbn-python. | **3k**/month |
| 728 | [django-restframework-apiv...](https://github.com/007gzs/django_restframework_apiview) | Django REST_framework APIView | **3k**/month |
| 729 | [django-login-required-mid...](https://github.com/CleitonDeLima/django-login-required-middleware) | Requires login to all requests through middleware. | **3k**/month |
| 730 | [django-afip](https://github.com/WhyNotHugo/django-afip) | AFIP integration for django | **3k**/month |
| 731 | [django-constrainedfilefie...](https://github.com/mbourqui/django-constrainedfilefield) | This Django app adds a new field type, ConstrainedFileField, that has ... | **3k**/month |
| 732 | [django-jsonforms](https://github.com/Aristotle-Metadata-Enterprises/django-jsonforms) | JSON Schema forms for Django | **3k**/month |
| 733 | [django-db-mutex](https://github.com/ambitioninc/django-db-mutex) | Acquire a mutex via the DB in Django | **3k**/month |
| 734 | [django-utils2](https://github.com/WoLpH/django-utils) | Django Utils is a module with some convenient utilities not included w... | **3k**/month |
| 735 | [django-unixtimestampfield](https://github.com/myyang/django-unixtimestampfield) | Django Unix timestamp (POSIX type) field | **3k**/month |
| 736 | [django-with-asserts](https://github.com/johnpaulett/django-with-asserts) | Helpers for testing Django using context managers | **3k**/month |
| 737 | [django-lfs](https://github.com/diefenbach/lfs-buildout-development) | LFS - Lightning Fast Shop | **3k**/month |
| 738 | [django-getpaid](https://github.com/sunscrapers/django-getpaid) | Multi-broker payment processor for Django. | **3k**/month |
| 739 | [django-chamber](https://github.com/druids/django-chamber) | Utilities library meant as a complement to django-is-core. | **3k**/month |
| 740 | [django-clamd](https://github.com/vstoykov/django-clamd) | django-clamd is a django integration with Clamd (Clamav daemon). | **3k**/month |
| 741 | [django-pymess](https://github.com/druids/django-pymess) | Pymess is a Django framework for sending messages | **3k**/month |
| 742 | [django-teryt-tree](https://github.com/watchdogpolska/django-teryt-tree) | Django-teryt-tree is a Django app that implements TERYT database as tr... | **3k**/month |
| 743 | [django-autotask](https://github.com/KerkhoffTechnologies/django-autotask) | Django app for working with Autotask. Defines models (tickets, members... | **3k**/month |
| 744 | [django-splash](https://github.com/edx/django-splash) | Splash screen middleware for Django apps | **3k**/month |
| 745 | [django-utils-six](https://github.com/whtsky/django-utils-six) | Forward compatibility django.utils.six for Django 3 | **3k**/month |
| 746 | [django-itelegram](https://github.com/YazdanRa/django-itelegram) | Developing Telegram bots on Django with extra built-in features | **3k**/month |
| 747 | [django-makeconf](https://github.com/ethanmcc/django-makeconf) | A Django app that provides commands to build deployment and other conf... | **3k**/month |
| 748 | [django_openstack_auth](https://pypi.org/project/django_openstack_auth/) | Django authentication backend for use with OpenStack Identity | **3k**/month |
| 749 | [django-qiyu-utils](https://pypi.org/project/django-qiyu-utils/) | Django 辅助工具类 | **3k**/month |
| 750 | [django-google-analytics-a...](https://github.com/praekeltfoundation/django-google-analytics) | Django Google Analytics app allowing for server side/non-js tracking. | **3k**/month |
| 751 | [django-q-sentry](https://pypi.org/project/django-q-sentry/) | A Sentry support plugin for Django Q | **3k**/month |
| 752 | [DjangoKit](https://pypi.org/project/DjangoKit/) | DjangoKit is a set of extensions for Django. | **3k**/month |
| 753 | [django-celerybeat-status](https://pypi.org/project/django-celerybeat-status/) | A simple django admin extension that shows when your periodic are goin... | **3k**/month |
| 754 | [django-classy-settings](https://pypi.org/project/django-classy-settings/) | Simple class-based settings for Django | **3k**/month |
| 755 | [django-councilmatic](https://pypi.org/project/django-councilmatic/) | Core functions for councilmatic.org family | **3k**/month |
| 756 | [django-etesync-journal](https://pypi.org/project/django-etesync-journal/) | The server side implementation of the EteSync protocol. | **3k**/month |
| 757 | [django-evolution](https://pypi.org/project/django-evolution/) | A database schema evolution tool for the Django web framework. | **3k**/month |
| 758 | [django-gulp-rev](https://pypi.org/project/django-gulp-rev/) | A simple Django integration with gulp-rev | **3k**/month |
| 759 | [django-kck](https://pypi.org/project/django-kck/) | Data orchestration for Django | **3k**/month |
| 760 | [django-livefield](https://pypi.org/project/django-livefield/) | Convenient soft-deletion support for Django models | **3k**/month |
| 761 | [django-modelapiview](https://github.com/TiphaineLAURENT/Django_APIView) | Two view classes to handle API endpoints | **3k**/month |
| 762 | [django-mssql](https://pypi.org/project/django-mssql/) | Django backend database support for MS SQL Server. | **3k**/month |
| 763 | [django-oscar-cybersource](https://pypi.org/project/django-oscar-cybersource/) | Integration between django-oscar and the Cybersource Secure Acceptance... | **3k**/month |
| 764 | [django-pagination](https://pypi.org/project/django-pagination/) | django-pagination | **3k**/month |
| 765 | [Django-Pizza](https://pypi.org/project/Django-Pizza/) | Yet another Django CMS. | **3k**/month |
| 766 | [django-pyston](https://github.com/matllubos/django-pyston) | Pyston is a Django mini-framework creating APIs. | **3k**/month |
| 767 | [django-radius](https://github.com/robgolding63/django-radius) | Django authentication backend for RADIUS | **3k**/month |
| 768 | [django-rest-framework-doc...](https://pypi.org/project/django-rest-framework-docs/) | An inventory tool for Django Rest Framework v2 API | **3k**/month |
...
| 778 | [django-forms-builder](https://github.com/stephenmcd/django-forms-builder) | A Django reusable app providing the ability for admin users to create ... | **2k**/month |
| 779 | [django-photologue](https://github.com/richardbarran/django-photologue) | Powerful image management for the Django web framework. | **2k**/month |
| 780 | [django-subdomains](https://github.com/tkaemming/django-subdomains) | Subdomain tools for the Django framework, including subdomain-based UR... | **2k**/month |
| 781 | [django-advanced-filters](https://github.com/modlinltd/django-advanced-filters) | A Django application for advanced admin filters | **2k**/month |
| 782 | [django-categories](https://github.com/callowayproject/django-categories) | A way to handle one or more hierarchical category trees in django. | **2k**/month |
| 783 | [django-hitcount](https://github.com/thornomad/django-hitcount) | Hit counting application for Django. | **2k**/month |
| 784 | [django-pg-zero-downtime-m...](https://github.com/tbicr/django-pg-zero-downtime-migrations) | Django postgresql backend that apply migrations with respect to databa... | **2k**/month |
| 785 | [django-mdeditor](https://github.com/pylixm/django-mdeditor) | A simple Django app to edit markdown text. | **2k**/month |
| 786 | [django-x509](https://github.com/openwisp/django-x509) | Reusable django app to generate and manage x509 certificates | **2k**/month |
| 787 | [django_react_templatetags](https://github.com/Frojd/django-react-templatetags) | This django library allows you to add React components into your djang... | **2k**/month |
| 788 | [django-tailwind](https://github.com/timonweb/django-tailwind) | Tailwind CSS Framework for Django projects | **2k**/month |
| 789 | [django-csvimport](https://github.com/edcrewe/django-csvimport) | Import CSV files to django models | **2k**/month |
| 790 | [django-permission](https://github.com/lambdalisue/django-permission) | A enhanced permission system which enable logical permissionsystems to... | **2k**/month |
| 791 | [django-kronos](https://github.com/jgorset/django-kronos) | Kronos is a Django application that makes it easy to define and schedu... | **2k**/month |
| 792 | [django-eventstream](https://github.com/fanout/django-eventstream) | Server-Sent Events for Django | **2k**/month |
| 793 | [django-custom-user](https://github.com/jcugat/django-custom-user) | Custom user model for Django >= 1.5 with the same behaviour as Djangos... | **2k**/month |
| 794 | [django-bulma](https://github.com/timonweb/django-bulma) | Bulma CSS Framework for Django projects | **2k**/month |
| 795 | [django-pwa](https://github.com/silviolleite/django-pwa) | A Django app to include a manifest.json and Service Worker instance to... | **2k**/month |
| 796 | [django-google-maps](https://github.com/madisona/django-google-maps) | Plugs google maps V3 api into Django admin. | **2k**/month |
| 797 | [django-db-mailer](https://github.com/LPgenerator/django-db-mailer) | Django module to easily send emails using django templates stored in a... | **2k**/month |
| 798 | [django-authority](https://github.com/jazzband/django-authority) | A Django app that provides generic per-object-permissions for Djangos ... | **2k**/month |
| 799 | [django-star-ratings](https://github.com/wildfish/django-star-ratings) | A Django app to add star ratings to models. | **2k**/month |
| 800 | [django-audit-log](https://github.com/vvangelovski/django-audit-log) | Audit trail for django models | **2k**/month |
| 801 | [django-softdelete](https://github.com/scoursen/django-softdelete) | Soft delete support for Django ORM, with undelete. | **2k**/month |
| 802 | [django-netjsonconfig](https://github.com/openwisp/django-netjsonconfig) | Configuration manager for embedded devices, implemented as a reusable ... | **2k**/month |
| 803 | [django-uwsgi](https://github.com/unbit/django-uwsgi) | uWSGI stuff for Django projects | **2k**/month |
| 804 | [django-behave](https://github.com/django-behave/django-behave) | Django Test Runner for the Behave BDD module | **2k**/month |
| 805 | [django-adminlte2](https://github.com/adamcharnock/django-adminlte2) | Admin LTE templates, admin theme, and template tags for Django | **2k**/month |
| 806 | [django-seo-js](https://github.com/skoczen/django-seo-js) | SEO support for angular, backbone, ember, famo.us, and other SPA apps ... | **2k**/month |
| 807 | [django-rest-assured](https://github.com/ydaniv/django-rest-assured) | Django REST Assured instantly test-covers your Django REST Framework b... | **2k**/month |
| 808 | [djangorestframework-seria...](https://github.com/evenicoulddoit/django-rest-framework-serializer-extensions) | Extensions to DRY up Django Rest Framework serializers | **2k**/month |
| 809 | [django-admin-shortcuts](https://github.com/alesdotio/django-admin-shortcuts) | Add simple and pretty shortcuts to the django admin homepage. | **2k**/month |
| 810 | [django-oscar-accounts](https://github.com/django-oscar/django-oscar-accounts) | Managed accounts for django-oscar | **2k**/month |
| 811 | [django-ddp](https://github.com/jazzband/django-ddp) | Django/PostgreSQL implementation of the Meteor server. | **2k**/month |
| 812 | [django-jwt-auth](https://github.com/jpadilla/django-jwt-auth) | JSON Web Token based authentication for Django | **2k**/month |
| 813 | [django-flexible-subscript...](https://github.com/studybuffalo/django-flexible-subscriptions) | A subscription and recurrent billing application for Django. | **2k**/month |
| 814 | [django-activeurl](https://github.com/hellysmile/django-activeurl) | Easy-to-use active URL highlighting for Django | **2k**/month |
| 815 | [django-fancy-cache](https://github.com/peterbe/django-fancy-cache) | A Django cache_page decorator on steroids | **2k**/month |
| 816 | [django-tastypie-swagger](https://github.com/concentricsky/django-tastypie-swagger) | An adapter to use swagger-ui with django-tastypie | **2k**/month |
| 817 | [django-admin-views](https://github.com/frankwiles/django-admin-views) | django-admin-views is a simple way to add custom admin views and direc... | **2k**/month |
| 818 | [django-object-tools](https://github.com/praekelt/django-object-tools) | Django app enabling painless creation of additional admin object tools... | **2k**/month |
| 819 | [django-staticfiles](https://github.com/jezdez/django-staticfiles) | A Django app that provides helpers for serving static files. | **2k**/month |
| 820 | [django-survey-and-report](https://github.com/Pierre-Sassoulas/django-survey) | A django survey app, based on and compatible with django-survey. You w... | **2k**/month |
| 821 | [django-chroniker](https://github.com/chrisspen/django-chroniker) | Easily control cron jobs via Djangos admin. | **2k**/month |
| 822 | [django-oscar-paypal](https://github.com/django-oscar/django-oscar-paypal) | Integration with PayPal Express, PayPal Payflow Pro and Adaptive Payme... | **2k**/month |
| 823 | [django-paging](https://github.com/dcramer/django-paging) | An efficient paginator that works. | **2k**/month |
| 824 | [django-adminlte3](https://github.com/d-demirci/django-adminlte3) | Admin LTE templates, admin theme, and template tags for Django | **2k**/month |
| 825 | [djangorestframework-expir...](https://github.com/JamesRitchie/django-rest-framework-expiring-tokens) | Expiring Authentication Tokens for Django REST Framework | **2k**/month |
| 826 | [django-leaflet-storage](https://github.com/umap-project/django-leaflet-storage) | Create collaborative maps on top of Geodjango and Leaflet. | **2k**/month |
| 827 | [django-contact-form](https://github.com/ubernostrum/django-contact-form) | A generic contact-form application for Django | **2k**/month |
| 828 | [django-tablib](https://github.com/joshourisman/django-tablib) | A wrapper around Kenneth Reitz tablib to work with Django models. | **2k**/month |
| 829 | [django-optimistic-lock](https://github.com/gavinwahl/django-optimistic-lock) | Offline optimistic locking for Django | **2k**/month |
| 830 | [django-xworkflows](https://github.com/rbarrois/django_xworkflows) | A django app enabling Django models to use xworkflows. | **2k**/month |
| 831 | [django-admin-row-actions](https://github.com/DjangoAdminHackers/django-admin-row-actions) | django admin row actions | **2k**/month |
| 832 | [django-simple-bulma](https://github.com/python-discord/django-simple-bulma) | Django application to add the Bulma CSS framework and its extensions | **2k**/month |
| 833 | [django-dynamic-model](https://github.com/rvinzent/django-dynamic-models) | Allow dynamic creation and updates to database schema at runtime. | **2k**/month |
| 834 | [django-gulp](https://github.com/beaugunderson/django-gulp) | Run your gulp tasks with runserver and collectstatic | **2k**/month |
| 835 | [django-selenium](https://github.com/dragoon/django-selenium) | Django Selenium Integration | **2k**/month |
...
| 840 | [django-cloud-browser](https://github.com/ryan-roemer/django-cloud-browser) | Django Cloud Browser application. | **2k**/month |
...
| 848 | [djangorestframework-compo...](https://github.com/niwinz/djangorestframework-composed-permissions) | Composed permissions for django-rest-framework | **2k**/month |
| 849 | [djangorecipe](https://github.com/rvanlaar/djangorecipe) | Buildout recipe for Django | **2k**/month |
| 850 | [django-debug-toolbar-line...](https://github.com/dmclain/django-debug-toolbar-line-profiler) | A panel for django-debug-toolbar that integrates information from line... | **2k**/month |
| 851 | [django-letsencrypt](https://github.com/urda/django-letsencrypt) | A simple Django app to handle Lets Encrypt ACME challenges. | **2k**/month |
| 852 | [django-password-policies](https://github.com/tarak/django-password-policies) | A Django application to implent password policies. | **2k**/month |
| 853 | [django-restricted-session...](https://github.com/mxsasha/django-restricted-sessions) | Restrict Django sessions to IP and/or user agent. | **2k**/month |
| 854 | [django-html_sanitizer](https://github.com/ui/django-html_sanitizer) | Provides a set of HTML cleaning utilities for django models, forms and... | **2k**/month |
| 855 | [django-carrot](https://github.com/chris104957/django-carrot) | A RabbitMQ asynchronous task queue for Django. | **2k**/month |
| 856 | [django-tsvector-field](https://github.com/damoti/django-tsvector-field) | Django field implementation for PostgreSQL tsvector. | **2k**/month |
| 857 | [django-rest-models](https://github.com/Yupeek/django-rest-models) | django Fake ORM model that query an RestAPI instead of a database — | **2k**/month |
| 858 | [django-admin-shell](https://github.com/djk2/django-admin-shell) |  | **2k**/month |
| 859 | [django-templatetag-handle...](https://github.com/makinacorpus/django-templatetag-handlebars) | Easily embed Handlebars.js templates in your django templates | **2k**/month |
| 860 | [django-postgres-extension...](https://github.com/primal100/django_postgres_extensions) | Extra features for django.contrib.postgres | **2k**/month |
| 861 | [django-admin-charts](https://github.com/PetrDlouhy/django-admin-charts) | django-admin-charts - Easily configurable charts statistics for `djang... | **2k**/month |
| 862 | [django-fullurl](https://github.com/Flimm/django-fullurl) | Adds three template tags to Django: `fullurl`, `fullstatic` and `build... | **2k**/month |
| 863 | [django-antispam](https://github.com/mixkorshun/django-antispam) | Anti-spam protection tools for django applications. | **2k**/month |
| 864 | [django-throttle-requests](https://github.com/sobotklp/django-throttle-requests) | A Django framework for application-layer rate limiting | **2k**/month |
| 865 | [django-recaptcha3](https://github.com/kbytesys/django-recaptcha3) | Django reCaptcha v3 field/widget | **2k**/month |
| 866 | [django-tabular-permission...](https://github.com/RamezIssac/django-tabular-permissions) | Display django permissions in a tabular format that is user friendly, ... | **2k**/month |
| 867 | [django-intercom](https://github.com/kencochrane/django-intercom) | Django App for integrating with intercom.io | **2k**/month |
| 868 | [django-argonauts](https://github.com/fusionbox/django-argonauts) | A lightweight collection of JSON helpers for Django. | **2k**/month |
| 869 | [django-sitemessage](https://github.com/idlesign/django-sitemessage) | Reusable application for Django introducing a message delivery framewo... | **2k**/month |
| 870 | [django-auth-ldap3-ad](https://github.com/Lucterios2/django_auth_ldap3_ad) | very simple authentication module for python3 / django / LDAP or AD | **2k**/month |
| 871 | [django-request-profiler](https://github.com/yunojuno/django-request-profiler) | A simple Django project profiler for timing HTTP requests. | **2k**/month |
| 872 | [django-csp-reports](https://github.com/adamalton/django-csp-reports) | A Django app for handling reports from web browsers of violations of y... | **2k**/month |
| 873 | [django-decouple](https://github.com/henriquebastos/django-decouple) | Strict separation of settings from code. | **2k**/month |
| 874 | [django-active-link](https://github.com/valerymelou/django-active-link) | The best way to highlight active links in your Django app. | **2k**/month |
| 875 | [django-logging-json](https://github.com/cipriantarta/django-logging) | A simple Django app to log requests/responses in various formats, such... | **2k**/month |
| 876 | [django-yubin](https://github.com/APSL/django-yubin) | A reusable Django app for composing and queueing emails Adds django-ma... | **2k**/month |
| 877 | [django-protector](https://github.com/grey0ne/django-protector) | Django application for managing object level permissions and generic g... | **2k**/month |
| 878 | [django-templates-macros](https://github.com/twidi/django-templates-macros) | Add macros to your django templates | **2k**/month |
| 879 | [django-precise-bbcode](https://github.com/ellmetha/django-precise-bbcode) | A django BBCode integration.. | **2k**/month |
| 880 | [djangorestframework-link-...](https://github.com/tbeadle/django-rest-framework-link-header-pagination) | Provide pagination using a Link HTTP header as described in https://de... | **2k**/month |
| 881 | [django-redis-sessions-for...](https://github.com/hellysmile/django-redis-sessions-fork) | Redis Session Backend For Django | **2k**/month |
| 882 | [django-djconfig](https://github.com/nitely/django-djconfig) | DjConfig is a Django app for storing dynamic configurations. | **2k**/month |
| 883 | [django-ultracache](https://github.com/praekelt/django-ultracache) | Drop-in replacement for Djangos template fragment caching. Provides au... | **2k**/month |
| 884 | [django-modelsdoc](https://github.com/tell-k/django-modelsdoc) | Create models definitions document from your Django project. | **2k**/month |
| 885 | [django-authlib](https://github.com/matthiask/django-authlib) | Authentication utils for Django | **2k**/month |
| 886 | [django-codemirror2](https://github.com/sk1p/django-codemirror2) | Django widgets for replacing textareas with CodeMirror2, an in-browser... | **2k**/month |
| 887 | [django-log-viewer](https://github.com/agusmakmun/django-log-viewer) | Django log viewer | **2k**/month |
| 888 | [django-ltree](https://github.com/mariocesar/django-ltree) | Django app to support ltree postgres extension | **2k**/month |
| 889 | [django-ulogin](https://github.com/marazmiki/django-ulogin) | User social authentication with ulogin.ru service | **2k**/month |
| 890 | [django-jsonfield-backport](https://github.com/laymonage/django-jsonfield-backport) | Backport of the cross-DB JSONField model and form fields from Django 3... | **2k**/month |
| 891 | [django-seeker](https://github.com/imsweb/django-seeker) | A python package for mapping and querying Django models in Elasticsear... | **2k**/month |
| 892 | [django-saml2-pro-auth](https://github.com/zibasec/django-saml2-pro-auth) | SAML2 authentication backend for Django wrapping OneLogins python-saml... | **2k**/month |
| 893 | [django-celery-transaction...](https://github.com/fellowshipofone/django-celery-transactions) | Django transaction support for Celery tasks. | **2k**/month |
| 894 | [django-docopt-command](https://github.com/mbraak/django-docopt-command) | Django-docopt-command allows you to write Django manage.py commands us... | **2k**/month |
| 895 | [django-jsonfallback](https://github.com/raphaelm/django-jsonfallback) | JSONField from django.contrib.postgres, but with a fallback to TextFie... | **2k**/month |
| 896 | [django-stomp](https://github.com/juntossomosmais/django-stomp) | A simple implementation of STOMP with Django | **2k**/month |
| 897 | [django-bananas](https://github.com/5monkeys/django-bananas) | Django Bananas - Django extensions the monkey way | **2k**/month |
| 898 | [django-etc](https://github.com/idlesign/django-etc) | Tiny stuff for Django that wont fit into separate apps. | **2k**/month |
| 899 | [django-group-by](https://github.com/kako-nawao/django-group-by) | Group by arbitrary model fields | **2k**/month |
| 900 | [django-zero](https://github.com/django-zero/django-zero) | Zero-configuration django projects. | **2k**/month |
| 901 | [django-ok-seo](https://github.com/LowerDeez/ok-seo) | django-ok-seo allows you to add meta tags and OpenGraph properties to ... | **2k**/month |
| 902 | [django-angular-dynamic-fo...](https://github.com/mesemus/django-angular-dynamic-forms) | Django Rest Framework meets Angular 5 material.io dynamic forms - rapi... | **2k**/month |
| 903 | [django-dynamic-filenames](https://github.com/codingjoe/django-dynamic-filenames) | Write advanced filename patterns using the Format String Syntax. | **2k**/month |
| 904 | [django-pdfkit](https://github.com/alexhayes/django-pdfkit) | Django view that converts HTML to PDF using webkit. | **2k**/month |
| 905 | [djangorestframework-recap...](https://github.com/Maximilien-R/django-rest-framework-recaptcha) | reCAPTCHA field for Django REST framework serializers. | **2k**/month |
| 906 | [django-3-jet](https://github.com/Barukimang/django-jet) | Modern template for Django admin interface with improved functionality | **2k**/month |
| 907 | [django-fontawesome-5](https://github.com/BenjjinF/django-fontawesome-5) | A utility for using icons in models, forms, and templates. | **2k**/month |
| 908 | [django-sizefield](https://github.com/leplatrem/django-sizefield) | A model field to store a file size, whose edition and display shows un... | **2k**/month |
| 909 | [django-ckeditor-filebrows...](https://github.com/nephila/django-ckeditor-filebrowser-filer) | A django-filer based CKEditor filebrowser | **2k**/month |
| 910 | [django-vkontakte-api](https://github.com/ramusus/django-vkontakte-api) | Django implementation for vkontakte API | **2k**/month |
| 911 | [django-pg-bulk-update](https://github.com/M1ha-Shvn/django-pg-bulk-update) | Django extension, executing bulk update operations for PostgreSQL | **2k**/month |
| 912 | [django-admin-extend](https://github.com/kux/django-admin-extend) | Provides functionality for extendingModelAdmin classes that have alrea... | **2k**/month |
| 913 | [django-sns-view](https://github.com/deep-c/django-sns-view) | A Django view that can be subscribed to Amazon SNS | **2k**/month |
| 914 | [django-heroku-connect](https://github.com/Thermondo/django-heroku-connect) | Django integration Salesforce using Heroku Connect. | **2k**/month |
| 915 | [django-pagetree](https://github.com/ccnmtl/django-pagetree) | Tree of Pages helper application | **2k**/month |
| 916 | [django-mailjet](https://github.com/kidig/django-mailjet) | A Django email backend for Mailjet | **2k**/month |
| 917 | [django-xforwardedfor-midd...](https://github.com/allo-/django-xforwardedfor-middleware) | Django X-Forwarded-For Middleware | **2k**/month |
| 918 | [django-generic-links](https://github.com/matagus/django-generic-links) | Simple and generic application for Django projects to attach and handl... | **2k**/month |
| 919 | [django-geoexplorer](https://github.com/GeoNode/django-geoexplorer) | Use GeoExplorer in your django projects | **2k**/month |
| 920 | [django-relativedelta](https://github.com/CodeYellowBV/django-relativedelta) | Django alternative to DurationField using dateutil.relativedelta | **2k**/month |
| 921 | [django-huey-monitor](https://github.com/boxine/django-huey-monitor) | Django based tool for monitoring huey task queue: https://github.com/c... | **2k**/month |
| 922 | [django-glrm](https://pypi.org/project/django-glrm/) | A Django middleware that make all views and URLs login required. | **2k**/month |
| 923 | [django-durationwidget](https://github.com/devangpadhiyar/django-durationwidget) | Django Duration field widget to handle duration field in the form | **2k**/month |
| 924 | [django-hierarkey](https://github.com/raphaelm/django-hierarkey) | Hierarchical key-value store for django | **2k**/month |
| 925 | [django-sortedm2m-filter-h...](https://github.com/svleeuwen/sortedm2m-filter-horizontal-widget) | Horizontal filter widget for django-sortedm2m | **2k**/month |
| 926 | [django-multifactor](https://github.com/oliwarner/django-multifactor) | Drop-in multifactor authentication subsystem for Django. | **2k**/month |
| 927 | [djangocassandra](https://github.com/Knotis/djangocassandra) | Cassandra support for the Django web framework | **2k**/month |
| 928 | [django-mcadmin](https://github.com/vint21h/django-mcadmin) | Easily run Django management commands from admin | **2k**/month |
| 929 | [django-pkgconf](https://github.com/byashimov/django-pkgconf) | Yet another application settings helper. | **2k**/month |
| 930 | [django-app-settings](https://github.com/pawamoy/django-appsettings) | Application settings helper for Django apps. | **2k**/month |
| 931 | [django-override-storage](https://github.com/danifus/django-override-storage) | Django test helpers to manage file storage side effects. | **2k**/month |
| 932 | [django-stuff](https://github.com/rhenter/django-stuff) | Library with common code for Django | **2k**/month |
| 933 | [django-boost](https://github.com/ChanTsune/django-boost) | Django Extension library | **2k**/month |
| 934 | [django-admin-thumbnails](https://github.com/BigglesZX/django-admin-thumbnails) | A Django app for DRY thumbnails in admin list views and forms. | **2k**/month |
| 935 | [django-report-utils](https://github.com/burke-software/django-report-utils) | Common report functions used by django-report-builder and django-repor... | **2k**/month |
| 936 | [django-debug-toolbar-forc...](https://github.com/barseghyanartur/django-debug-toolbar-force) | Force debugging of partial- or non-HTML views in django-debug-toolbar. | **2k**/month |
| 937 | [django-pragmatic](https://github.com/PragmaticMates/django-pragmatic) | Pragmatic tools and utilities for Django projects | **2k**/month |
| 938 | [django-proxy-server](https://github.com/lmanzurv/django_proxy_server) | This is a django application to use django as a proxy server between a... | **2k**/month |
| 939 | [django-ripple_api](https://github.com/42cc/ripple_api) | Python wrapper for the Ripple API | **2k**/month |
| 940 | [django-elastic-appsearch](https://github.com/CorrosiveKid/django_elastic_appsearch) | Integrate your Django Project with Elastic App Search with ease. | **2k**/month |
| 941 | [django-hint](https://github.com/VieoloOU/django-hint) | Typehinting package for django | **2k**/month |
| 942 | [django-geostore](https://github.com/Terralego/django-geostore) | Django geographic store and vector tile generation | **2k**/month |
| 943 | [django-groupadmin-users](https://github.com/Microdisseny/django-groupadmin-users) | Edit users in group from the Group add and edit pages | **2k**/month |
| 944 | [django-richenum](https://github.com/hearsaycorp/django-richenum) | Django Enum library for python. | **2k**/month |
| 945 | [django-asana](https://github.com/sbywater/django-asana) | Django Asana integration project | **2k**/month |
| 946 | [django-enforce-host](https://github.com/dabapps/django-enforce-host) | Middleware to redirect requests to a canonical hostname | **2k**/month |
| 947 | [django-jacc](https://github.com/kajala/django-jacc) | Simple double entry accounting system (debits/credits) for Django proj... | **2k**/month |
| 948 | [django-customer-billing](https://github.com/skioo/django-customer-billing) |  | **2k**/month |
| 949 | [django-on-heroku](https://github.com/pkrefta/django-on-heroku) | This package simplifies running a Django app on Heroku platform. | **2k**/month |
| 950 | [django-cast](https://github.com/ephes/django-cast) | Just another blogging / podcasting package | **2k**/month |
| 951 | [django-fido](https://github.com/CZ-NIC/django-fido) | Django application for FIDO protocol | **2k**/month |
| 952 | [django-auth-token](https://github.com/druids/django-auth-token) | Django authorization via tokens. | **2k**/month |
| 953 | [django-samesite-none](https://github.com/zvyn/django-samesite-none) | Django middleware which sets SameSite flag to None for cookies where i... | **2k**/month |
| 954 | [django-template-engines](https://github.com/Terralego/django-template-engines) | Additional template engines for Django. | **2k**/month |
| 955 | [django-alt](https://github.com/poskadesign/django-alt) | Alternative approach to data validation and REST endpoints in Django a... | **2k**/month |
| 956 | [django-flashpolicies](https://github.com/ubernostrum/django-flashpolicies) | Flash cross-domain policies for Django sites | **2k**/month |
| 957 | [django-agent-trust](https://github.com/django-otp/django-agent-trust) | A framework for managing agent trust, such as public vs. private compu... | **2k**/month |
| 958 | [django-limits](https://github.com/LegoStormtroopr/django-city-limits) |  | **2k**/month |
| 959 | [django-simple-log](https://github.com/kindlycat/django-simple-log) | Logging django models changes. | **2k**/month |
| 960 | [Django-CryptographicField...](https://github.com/Shahprogrammer/Django-CryptographicFields) | A Django app for cryptography in Django Models. | **2k**/month |
| 961 | [django-perimeter](https://github.com/yunojuno/django-perimeter) | Site-wide perimeter access control for Django projects. | **2k**/month |
| 962 | [django-exporter](https://github.com/prezi/django-exporter) | Export Django metrics for Prometheus. | **2k**/month |
| 963 | [django-psycopg2-extension](https://github.com/druids/django-psycopg2-extension) | Library contains django commands which helps to prepare and manage Pos... | **2k**/month |
| 964 | [django-postgresql-dag](https://github.com/OmenApps/django-postgresql-dag) | Directed Acyclic Graph implementation for Django & Postgresql | **2k**/month |
| 965 | [django-markdownfield](https://github.com/dmptrluke/django-markdownfield) | A simple custom field for Django that can safely render Markdown and s... | **2k**/month |
| 966 | [django-pynotify](https://github.com/druids/django-pynotify) | General purpose notification library for Django | **2k**/month |
| 967 | [django-humanize](https://github.com/oasiswork/django-humanize) | Use humanize 3rd-party lib as template filters | **2k**/month |
| 968 | [django-atom](https://github.com/ad-m/django-atom) | A different stuff for Django to faster make a world a better place. | **2k**/month |
| 969 | [django-user-email-extensi...](https://github.com/ArieLevs/Django-User-Email-Extension) | User model extender for django | **2k**/month |
| 970 | [django-powerbank](https://github.com/wooyek/django-powerbank) | Extra power for included batteries | **2k**/month |
| 971 | [django-http-referrer-poli...](https://github.com/DmytroLitvinov/django-http-referrer-policy) | django-http-referrer-policy provides a middleware class implementing t... | **2k**/month |
| 972 | [django-codenerix-invoicin...](https://github.com/codenerix/django-codenerix-invoicing) | Codenerix Invoicing is a module that enables CODENERIX to manage bills... | **2k**/month |
| 973 | [django-jsonattrs](https://github.com/Cadasta/django-jsonattrs) | Django app to provide Postgres JSON-based attribute management. | **2k**/month |
| 974 | [django-codenerix-pos](https://github.com/codenerix/django-codenerix-pos) | Codenerix Products is a module that enables CODENERIX to set Point of ... | **2k**/month |
| 975 | [django-po2xls](https://github.com/vint21h/django-po2xls) | Convert gettext .po files to .xls | **2k**/month |
| 976 | [django-extended-shell](https://github.com/detect-dev/django-extended-shell) | Django shell with imported models | **2k**/month |
| 977 | [django2-semantic-ui](https://github.com/franklintiel/django2-semantic-ui) | Library to easy install, configure and use Semantic UI framework with ... | **2k**/month |
| 978 | [django-markitup](https://github.com/CTPUG/django-markitup) | Markup handling for Django using the MarkItUp! universal markup editor | **2k**/month |
| 979 | [django-standard-form](https://github.com/alesdotio/django-standard-form) | Quick and simple django templatetags for displaying forms. | **2k**/month |
| 980 | [django-xff](https://github.com/ferrix/xff) | Django X-Forwarded-For Properly | **2k**/month |
| 981 | [django-awl](https://github.com/cltrudeau/django-awl) | Miscellaneous django tools | **2k**/month |
| 982 | [django-fakeredis](https://github.com/o3o3o/django-fakeredis) | Easier to use fakeredis in Django. | **2k**/month |
| 983 | [django-dbmi-client](https://github.com/hms-dbmi/django-dbmi-client) |  | **2k**/month |
| 984 | [django-kdl-wagtail](https://github.com/kingsdigitallab/django-kdl-wagtail) | KDL Wagtail Base Models | **2k**/month |
| 985 | [django-generic-m2m-field](https://github.com/druids/django-generic-m2m-field) | Django generic many to many field library. | **2k**/month |
| 986 | [django-celery-extensions](https://github.com/druids/django-celery-extensions) | Django celery extensions library. | **2k**/month |
| 987 | [django-sms-validator](https://github.com/matllubos/django-sms-validator) | Python library for sms validation. | **2k**/month |
| 988 | [django-verification-token](https://github.com/druids/django-verification-token) | Django library for generation verification toekens. | **2k**/month |
| 989 | [django-pg-hll](https://github.com/M1ha-Shvn/django-pg-hll) | Provides a django wrapper for postgresql-hll library by CitusData | **2k**/month |
| 990 | [django-choice-enumfields](https://github.com/druids/django-choice-enumfields) | Real Python Enums for Django. | **2k**/month |
| 991 | [django-bootstrap4-form](https://github.com/gwasser/django-bootstrap4-form) | django-bootstrap4-form | **2k**/month |
| 992 | [django-fluent-utils](https://github.com/django-fluent/django-fluent-utils) | Internal utilities for code sharing between django-fluent modules | **2k**/month |
| 993 | [django-staff-sso-client](https://github.com/uktrade/django-staff-sso-client) | Reusable Django app to facilitate gov.uk Staff Single Sign On | **2k**/month |
| 994 | [django-onfido](https://github.com/yunojuno/django-onfido) | Django app for integration with Onfido. | **2k**/month |
| 995 | [django-settings-local](https://github.com/fasih/django-settings-local) | Manage Django Local Settings | **2k**/month |
| 996 | [django-cloudinary-storage](https://github.com/tiagocordeiro/django-cloudinary-storage) | Django package that provides Cloudinary storages for both media and st... | **2k**/month |
| 997 | [django-context-cache](https://github.com/druids/django-context-cache) | Django context cache library. | **2k**/month |
| 998 | [django-emailtools-reloade...](https://github.com/barseghyanartur/django-emailtools-reloaded) | App for Django featuring class based email sending. | **2k**/month |
| 999 | [django-fperms](https://github.com/druids/django-fperms) | Flexible Django permissions backend | **2k**/month |
| 1000 | [django-fperms-iscore](https://github.com/druids/django-fperms-iscore) | Perms for iscore library | **2k**/month |
